...
GRID_LEN = 6                                                                                   #Pour afficher toutes les cases
...
class Grille6(Frame):                                   #FRAME = Cadre
    def __init__(self):
        Frame.__init__(self)
        ...
        if key in self.commands:
            ...
            if done:
                ...
                if game_state(self.matrix)=='win':
                    self.grid_cells[3][1].configure(text="Tu",bg=BACKGROUND_COLOR_CELL_EMPTY)
                    self.grid_cells[3][2].configure(text="as",bg=BACKGROUND_COLOR_CELL_EMPTY)
                    self.grid_cells[3][3].configure(text="ga",bg=BACKGROUND_COLOR_CELL_EMPTY)
                    self.grid_cells[3][4].configure(text="gné!",bg=BACKGROUND_COLOR_CELL_EMPTY)
                if game_state(self.matrix)=='lose':
                    self.grid_cells[3][1].configure(text="Tu",bg=BACKGROUND_COLOR_CELL_EMPTY)
                    self.grid_cells[3][2].configure(text="as",bg=BACKGROUND_COLOR_CELL_EMPTY)
                    self.grid_cells[3][3].configure(text="per",bg=BACKGROUND_COLOR_CELL_EMPTY)
                    self.grid_cells[3][4].configure(text="du!",bg=BACKGROUND_COLOR_CELL_EMPTY)
